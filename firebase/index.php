<html>
    <head>
        <title>AndroidPush | Firebase Cloud Messaging | NevadaSoft</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        if ($push_type == 'topic') {
            $json = $push->getPush();
            $response = $firebase->sendToTopic('global', $json, $api_key);
        ...
        <div class="container">
            ...
            <form class="pure-form pure-form-stacked" method="get">
                <fieldset>
                    ...
                    <label for="redId">Firebase API Key</label>
                    <input type="text" id="" name="api_key" class="pure-input-1-2" placeholder="Enter firebase api key" required>
 
                    <label for="redId">Device Token</label>
                    <input type="text" id="redId" name="regId" class="pure-input-1-2" placeholder="Enter Device Token" required>
